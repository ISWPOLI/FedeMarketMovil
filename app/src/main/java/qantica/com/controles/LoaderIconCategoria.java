...
public class LoaderIconCategoria extends LinearLayout {
     ...
     * @param attrSet
     */
    public LoaderIconCategoria(final Context context, final AttributeSet attrSet) {
    ...
    public void setImageDrawable(final String imageUrl, final String servlet) {
        ...
        new Thread() {
            public void run() {
                try {
                    File file = new File(mContext.getCacheDir().getAbsolutePath(), imageUrl);
                    if (file.exists()) {
                        ...
                        try {
                            ...
                            File _file = new File(mContext.getCacheDir().getAbsolutePath(), imageUrl);
